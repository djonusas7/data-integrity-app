...
# -----------------------------------------------------------------------------
# User Inputs for Data and Output Directories
# -----------------------------------------------------------------------------
...
if run_button:
    ...
    try:
        ...
        # ----------------------------------------------------------------
        # 1) Merge on ALL shared columns to detect partial mismatches.
        ...
        # ----------------------------------------------------------------
        # 2) For each mismatched row, check for a row with the same key in current_df:
        #    - If missing, indicate "Row is missing"
        #    - Otherwise, list discrepancies in non-key columns.
        # ----------------------------------------------------------------
        ...
        # ----------------------------------------------------------------
        # 3) Identify new rows in current_df (excluding those already flagged)
        # ----------------------------------------------------------------
